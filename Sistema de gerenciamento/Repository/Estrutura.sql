...
id INT PRIMARY KEY IDENTITY(1,1),
id_usuario_responsavel INT, FOREIGN KEY(id_usuario) REFERENCES usuarios(id),
id_projeto INT, FOREIGN KEY(id_projeto) REFERENCES projetos(id),
id_categorias INT, FOREIGN KEY(id_categoria) REFERENCES categorias(id),
titulo VARCHAR(50),
descricao TEXT,
duracao DATETIME2(7)
);
